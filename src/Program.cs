    ...
    public class Program
    {
        ...
        private static void ConfigGit(UrlTemplate urlTemplate)
        {
            ...
            if (Msdos.IsInstalled("git"))
            {
                ...
                Msdos.Run("git", $"config --global no.proxy {urlTemplate.ProxyExceptions}");
            }
        }
        ...
        private static void SettingUserData(IUserData data)
        {
            var urlTemplate = new UrlTemplate(data);
